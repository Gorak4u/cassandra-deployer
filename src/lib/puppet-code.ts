...
export const puppetCode = {
  ...
  manifests: {
    'init.pp': [
      ...
      '  Optional[String] $java_package_version = lookup(\'cassandra::java_package_version\', { default_value => \'\' }),',
      ...
      '  String $jamm_source                = lookup(\'cassandra::jamm_source\', { default_value => \'puppet:///modules/profile_ggonda_cassandr/jamm-0.3.2.jar\' })',
      ') {',
      '',
