...
export const puppetCode = {
  ...
  manifests: {
    'init.pp': [
      ...
      '  Boolean $use_java11                     = $profile_ggonda_cassandr::params::use_java11,',
      '  Optional[Boolean] $use_g1_gc            = $profile_ggonda_cassandr::params::use_g1_gc,',
      '  Optional[Boolean] $use_shenandoah_gc    = $profile_ggonda_cassandr::params::use_shenandoah_gc,',
      '  Hash $racks                             = $profile_ggonda_cassandr::params::racks,',
      '  # cassandra.yaml main settings',
      '  Integer $concurrent_compactors          = $profile_ggonda_cassandr::params::concurrent_compactors,',
      '  Integer $compaction_throughput_mb_per_sec = $profile_ggonda_cassandr::params::compaction_throughput_mb_per_sec,',
      '  Integer $tombstone_warn_threshold       = $profile_ggonda_cassandr::params::tombstone_warn_threshold,',
      '  Integer $tombstone_failure_threshold    = $profile_ggonda_cassandr::params::tombstone_failure_threshold,',
      '  # OS Tuning settings',
      '  Hash $sysctl_settings                   = $profile_ggonda_cassandr::params::sysctl_settings,',
      '  Hash $limits_settings                   = $profile_ggonda_cassandr::params::limits_settings,',
      '  # New parameters for repo and firewall management',
      '  Boolean $manage_repo                    = $profile_ggonda_cassandr::params::manage_repo,',
      '  Boolean $manage_firewall                = $profile_ggonda_cassandr::params::manage_firewall,',
      ...
      '  if $manage_firewall {',
      '    contain profile_ggonda_cassandr::firewall',
      '  }',
      ...
      '',
      '  if $manage_firewall {',
      '    Class[\'profile_ggonda_cassandr::config\'] -> Class[\'profile_ggonda_cassandr::firewall\']',
      '  }',
      '}',
    ].join('\\n'),
    'params.pp': [
    ...
    'java.pp': [
      ...
      'class profile_ggonda_cassandr::java inherits profile_ggonda_cassandr::params {',
      '',
      ...
      '  $java_package_name = lookup(\'profile_ggonda_cassandr::java_package_name\', { default_value => $default_java_package })',
      '',
