...
export const puppetCode = {
  ...
  manifests: {
    ...
    'install.pp': [
      ...
      'class profile_ggonda_cassandr::install inherits cassandra {',
      '',
    ...
    'config.pp': [
      ...
      'class profile_ggonda_cassandr::config inherits cassandra {',
      '',
    ...
    'service.pp': [
      ...
      'class profile_ggonda_cassandr::service inherits cassandra {',
      '',
      '  # Cassandra service',
      '  service { \'cassandra\':',
      '    ensure     => running,',
    ...
    'java.pp': [
      ...
      'class profile_ggonda_cassandr::java inherits cassandra {',
      '',
  ...
  templates: {
    'cassandra.yaml.erb': [
      ...
      '',
      'cluster_name: \'<%= @cassandra_version.start_with?("3.") ? @cluster_name : @cassandra.cluster_name %>\'',
      'num_tokens: 256',
    ...
    'cassandra-rackdc.properties.erb': [
      ...
      'rack=<%= @cassandra.racks[@facts[\'gce\'][\'instance\'][\'zone\']] || \'rack1\' %>',
      '<% else -%>',
