...
export const puppetCode = {
  ...
  manifests: {
    'init.pp': [
      '# @summary A profile class to manage Apache Cassandra configuration.',
      '# This class gathers all configuration from Hiera and passes it to the',
      '# main cassandra component class.',
    ...
    'cassandra.pp': [
      ...
      '# This class receives all its parameters from the profile_ggonda_cassandr profile.',
      'class cassandra (',
    ...
    'java.pp': [
      ...
      '  }',
      '',
      '  $java_ensure_version = if $cassandra::java_package_version and $cassandra::java_package_version != \'\' {',
