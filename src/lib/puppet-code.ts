...
export const puppetCode = {
  ...
  manifests: {
    'init.pp': [
      '# @summary The profile class that wraps the cassandra component module.',
      '# This class should be included on any node that needs cassandra.',
      '# It retrieves all configuration from Hiera and passes it to the main cassandra class.',
