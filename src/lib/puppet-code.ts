...
export const puppetCode = {
  ...
  manifests: {
    'init.pp': [
      ...
      '  String $cluster_name             = lookup(\'profile_ggonda_cassandr::cluster_name\', { default_value => \'ggonda-cass-cluster\' }),',
      '  String $seeds                    = lookup(\'profile_ggonda_cassandr::seeds\', { default_value => \'10.93.16.206,10.93.16.127,10.93.17.191\' }),',
      ...
      '  String $cassandra_password       = lookup(\'profile_ggonda_cassandr::cassandra_password\', { default_value => \'PP#C@ss@ndr@000\' }),',
      '  String $max_heap_size            = lookup(\'profile_ggonda_cassandr::max_heap_size\', { default_value => \'3G\' }),',
      ...
      '  Boolean $disable_swap             = lookup(\'profile_ggonda_cassandr::disable_swap\', { default_value => false }),',
      ...
      '  # SSL/TLS settings',
      '  Boolean $ssl_enabled              = lookup(\'profile_ggonda_cassandr::ssl_enabled\', { default_value => true }),',
      '  String $target_dir                  = lookup(\'profile_ggonda_cassandr::ssl_target_dir\', { default_value => \'/etc/pki/tls/certs\' }),',
      '  String $keystore_path            = lookup(\'profile_ggonda_cassandr::keystore_path\', { default_value => \'/etc/pki/tls/certs/etc/keystore.jks\' }),',
      '  String $keystore_password        = lookup(\'profile_ggonda_cassandr::keystore_password\', { default_value => \'ChangeMe\' }),',
      '  String $truststore_path          = lookup(\'profile_ggonda_cassandr::truststore_path\', { default_value => \'/etc/pki/ca-trust/extracted/java/cacerts\' }),',
      '  String $truststore_password      = lookup(\'profile_ggonda_cassandr::truststore_password\', { default_value => \'changeit\' }),',
      '  String $internode_encryption     = lookup(\'profile_ggonda_cassandr::internode_encryption\', { default_value => \'all\' }),',
      '  Boolean $internode_require_client_auth = lookup(\'profile_ggonda_cassandr::internode_require_client_auth\', { default_value => false }),',
      ...
      '  String  $client_keystore_path        = lookup(\'profile_ggonda_cassandr::client_keystore_path\', { default_value => \'/etc/pki/tls/certs/etc/keystore.jks\' }),',
      '  String  $client_truststore_path      = lookup(\'profile_ggonda_cassandr::client_truststore_path\', { default_value => \'/etc/pki/ca-trust/extracted/java/cacerts\' }),',
      '  String  $client_truststore_password  = lookup(\'profile_ggonda_cassandr::client_truststore_password\', { default_value => \'changeit\' }),',
      ...
      '  # profile_ggonda_cassandr.yaml main settings',
      '  Integer $concurrent_compactors          = lookup(\'profile_ggonda_cassandr::concurrent_compactors\', { default_value => 2 }),',
      ...
      '  # OS Tuning settings',
      '  Hash $sysctl_settings                   = lookup(\'profile_ggonda_cassandr::sysctl_settings\', { default_value => { \'vm.max_map_count\' => \'1048576\' } }),',
      '  Hash $limits_settings                   = lookup(\'profile_ggonda_cassandr::limits_settings\', { default_value => { \'memlock\' => \'unlimited\', \'nofile\'  => \'100000\', \'nproc\'   => \'32768\', \'as\' => \'unlimited\' } }),',
      ...
      '  String $cassandra_user = lookup(\'profile_ggonda_cassandr::user\', { default_value => \'cassandra\' }),',
      '  String $cassandra_group = lookup(\'profile_ggonda_cassandr::group\', { default_value => \'cassandra\' }),',
      '  # Internal settings',
      '  String $repo_baseurl               = lookup(\'profile_ggonda_cassandr::repo_baseurl\', { default_value => \'https://repocache.nonprod.ppops.net/artifactory/apache-org-cassandra/\' }),',
      '  String $repo_gpgkey                = lookup(\'profile_ggonda_cassandr::repo_gpgkey\', { default_value => \'https://repocache.nonprod.ppops.net/artifactory/apache-org-cassandra-gpg-keys/KEYS\' }),',
      '  Array[String] $package_dependencies = lookup(\'profile_ggonda_cassandr::package_dependencies\', { default_value => [\'jemalloc\',\'python3\',\'numactl\'] }),',
      '  String $manage_bin_dir             = lookup(\'profile_ggonda_cassandr::manage_bin_dir\', { default_value => \'/usr/local/bin\' }),',
      '  String $change_password_cql        = lookup(\'profile_ggonda_cassandr::change_password_cql\', { default_value => \'/tmp/change_password.cql\' }),',
      '  String $cqlsh_path_env             = lookup(\'profile_ggonda_cassandr::cqlsh_path_env\', { default_value => \'/usr/bin:/usr/local/bin\' }),',
      '  String $jamm_target                = lookup(\'profile_ggonda_cassandr::jamm_target\', { default_value => \'/usr/share/cassandra/lib/jamm-0.3.2.jar\' }),',
      '  String $jamm_source                = lookup(\'profile_ggonda_cassandr::jamm_source\', { default_value => \'puppet:///modules/profile_ggonda_cassandr/jamm-0.3.2.jar\' })',
      ') {',
      '',
    ...
    'install.pp': [
      ...
      '  user { $profile_ggonda_cassandr::cassandra_user:',
      '    ensure     => \'present\',',
      '    system     => true,',
      '  }',
      '',
      '  group { $profile_ggonda_cassandr::cassandra_group:',
      '    ensure => \'present\',',
      '    system => true,',
      '  }',
      '',
    ...
    'config.pp': [
      ...
      '    ensure  => \'directory\',',
      '    owner   => $profile_ggonda_cassandr::cassandra_user,',
      '    group   => $profile_ggonda_cassandr::cassandra_group,',
      '    mode    => \'0700\',',
  ...
  templates: {
    'cassandra.yaml.erb': [
      ...
      '',
      'cluster_name: \'<%= @profile_ggonda_cassandr_version.start_with?("3.") ? @cluster_name : @profile_ggonda_cassandr.cluster_name %>\'',
      'num_tokens: 256',
    ...
    'cassandra_limits.conf.erb': [
      ...
      '<%= @profile_ggonda_cassandr.cassandra_user %> - <%= limit %> <%= value %>',
      '<% end -%>',
    ].join('\n'),
    'sysctl.conf.epp': [
      '# Generated by Puppet',
