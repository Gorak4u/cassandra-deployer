...
export const puppetCode = {
  ...
  manifests: {
    'init.pp': [
      ...
      '  # Hiera lookups for all parameters',
      ...
      '',
      '  # Resource-like declaration of the config class, passing all variables',
    ...
    'config.pp': [
      ...
      '  String $jamm_target,',
      '  String $jamm_source',
      ') inherits profile_ggonda_cassandr {',
    ...
    'java.pp': [
      ...
      '  }',
      '',
      '  $java_ensure_version = if $java_package_version != \'\' {',
