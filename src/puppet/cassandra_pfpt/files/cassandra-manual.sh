...
echo -e ""
echo -e "This profile installs a unified administrative wrapper script, \`cass-ops\`, at \`/usr/local/sbin\`. This is your primary entry point for all manual and automated operational tasks. It simplifies management by providing a single, memorable command with clear, grouped sub-commands."
echo -e ""
echo -e "To see all available commands, simply run it with no arguments:"
echo -e ""
echo -e "${CYAN}\`\`\`bash"
echo -e "$ sudo /usr/local/sbin/cass-ops"
echo -e "\`\`\`${NC}"
...
echo -e ""
echo -e "*   ${BOLD}Check the Local Node:${NC} Run \`sudo /usr/local/sbin/cass-ops health\`. This script is your first stop. It checks disk space, node status (UN), gossip state, active streams, and recent log exceptions, giving you a quick \"go/no-go\" for maintenance."
echo -e "*   ${BOLD}Check Cluster Connectivity:${NC} Run \`sudo /usr/local/sbin/cass-ops cluster-health\`. This verifies that the node can communicate with the cluster and that the CQL port is open."
echo -e "*   ${BOLD}Check Disk Space Manually:${NC} Run \`sudo /usr/local/sbin/cass-ops disk-health\` to see the current free space percentage on the data volume."
echo -e ""
...
echo -e "2.  Execute \`sudo /usr/local/sbin/cass-ops restart\`."
...
echo -e "2.  Run \`sudo /usr/local/sbin/cass-ops decommission\`."
...
echo -e "    ${CYAN}\`\`\`bash"
echo -e "    sudo /usr/local/sbin/cass-ops replace <ip_of_dead_node>"
echo -e "    \`\`\`${NC}"
...
echo -e "    ${CYAN}\`\`\`bash"
echo -e "    sudo /usr/local/sbin/cass-ops repair"
echo -e "    \`\`\`${NC}"
echo -e "*   ${BOLD}To manually repair a specific keyspace:${NC}"
echo -e "    ${CYAN}\`\`\`bash"
echo -e "    sudo /usr/local/sbin/cass-ops repair my_keyspace"
echo -e "    \`\`\`${NC}"
echo -e ""
...
echo -e "sudo /usr/local/sbin/cass-ops compact -k my_keyspace -t my_table"
echo -e ""
echo -e "# Compact an entire keyspace"
echo -e "sudo /usr/local/sbin/cass-ops compact -k my_keyspace"
echo -e "\`\`\`${NC}"
echo -e ""
...
echo -e ""
echo -e "${CYAN}\`\`\`bash"
echo -e "sudo /usr/local/sbin/cass-ops garbage-collect -k my_keyspace -t users"
echo -e "\`\`\`${NC}"
echo -e ""
...
echo -e ""
echo -e "${CYAN}\`\`\`bash"
echo -e "sudo /usr/local/sbin/cass-ops upgrade-sstables"
echo -e "\`\`\`${NC}"
echo -e ""
...
echo -e ""
echo -e "${CYAN}\`\`\`bash"
echo -e "sudo /usr/local/sbin/cass-ops cleanup"
echo -e "\`\`\`${NC}"
) | less -R
}
...
while true; do
    ...
    case $choice in
        ...
        7) /usr/local/sbin/cass-ops backup-guide ;;
        8) show_production_readiness ;;
        9) show_hiera_reference ;;
        10) /usr/local/sbin/cass-ops puppet-guide ;;
        q|Q) break ;;
