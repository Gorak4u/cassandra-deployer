...
# Use less to allow scrolling. The -R flag interprets ANSI color codes.
(
...
echo -e "4.  Operator's Quick Reference: The \`cassandra-admin\` Command"
...
echo -e "\`\`\`${NC}"
echo -e ""
echo -e "> All configuration for the node should be provided via your Hiera data source (e.g., in your \`common.yaml\` or node-specific YAML files). The backup scripts require the \`jq\`, \`awscli\`, and \`openssl\` packages, which this profile will install by default."
echo -e ""
echo -e "---"
echo -e ""
...
echo -e "---"
echo -e ""
echo -e "${BOLD}${BLUE}## Operator's Quick Reference: The \`cassandra-admin\` Command${NC}"
echo -e ""
echo -e "This profile installs a unified administrative wrapper script at \`/usr/local/bin/cassandra-admin\`. This is your primary entry point for all manual operational tasks. It simplifies management by providing a single, memorable command with clear sub-commands."
echo -e ""
echo -e "To see all available commands, simply run it with \`help\`:"
echo -e ""
echo -e "${CYAN}\`\`\`"
echo -e "\$ sudo /usr/local/bin/cassandra-admin help"
echo -e ""
echo -e "Cassandra Operations Master Script"
echo -e ""
echo -e "A unified wrapper for managing common Cassandra operational tasks on this node."
echo -e ""
echo -e "Usage: /usr/local/bin/cassandra-admin <command> [arguments...]"
echo -e ""
echo -e "--- Node & Cluster Status ---"
...
echo -e "  disk-health            Check disk usage against warning/critical thresholds. Usage: disk-health [-p /path] [-w 80] [-c 90]"
...
echo -e "  replace <dead_node_ip> Configure this NEW, STOPPED node to replace a dead node."
echo -e "  rebuild <source_dc>    Rebuild the data on this node by streaming from another datacenter."
echo -e ""
echo -e "--- Data Management & Repair ---"
echo -e "  repair [<keyspace>]    Run a safe, granular repair on the node's token ranges. Can target a specific keyspace."
echo -e "  cleanup [opts]         Run 'nodetool cleanup' with safety checks. Use 'cleanup -- --help' for options."
echo -e "  compact [opts]         Run 'nodetool compact' with safety checks. Use 'compact -- --help' for options."
echo -e "  garbage-collect [opts] Run 'nodetool garbagecollect' with safety checks. Use 'garbage-collect -- --help' for options."
echo -e "  upgrade-sstables [opts]Run 'nodetool upgradesstables' with safety checks. Use 'upgrade-sstables -- --help' for options."
echo -e ""
echo -e "--- Backup & Recovery ---"
echo -e "  backup                 Manually trigger a full, node-local backup to S3."
echo -e "  snapshot [<keyspaces>] Take an ad-hoc snapshot with a generated tag. Optionally specify comma-separated keyspaces."
echo -e "  restore [opts]         Restore data from S3 backups. This is a complex command; run 'restore -- --help' for its usage."
echo -e ""
echo -e "--- Advanced & Destructive Operations (Use with caution!) ---"
echo -e "  assassinate <dead_node_ip> Forcibly remove a dead node from the cluster's gossip ring."
echo -e ""
echo -e "--- Performance Testing ---"
echo -e "  stress [opts]          Run 'cassandra-stress' via a robust wrapper. Run 'stress -- --help' for options."
echo -e "\`\`\`${NC}"
echo -e ""
echo -e "---"
echo -e ""
...
echo -e ""
echo -e "*   ${BOLD}Check the Local Node:${NC} Run \`sudo /usr/local/bin/cassandra-admin health\`. This script is your first stop. It checks disk space, node status (UN), gossip state, active streams, and recent log exceptions, giving you a quick \"go/no-go\" for maintenance."
echo -e "*   ${BOLD}Check Cluster Connectivity:${NC} Run \`sudo /usr/local/bin/cassandra-admin cluster-health\`. This verifies that the node can communicate with the cluster and that the CQL port is open."
echo -e "*   ${BOLD}Check Disk Space Manually:${NC} Run \`sudo /usr/local/bin/cassandra-admin disk-health\` to see the current free space percentage on the data volume."
echo -e ""
...
echo -e "2.  Execute \`sudo /usr/local/bin/cassandra-admin restart\`."
...
echo -e "2.  Run \`sudo /usr/local/bin/cassandra-admin decommission\`."
...
echo -e "    ${CYAN}\`\`\`bash"
echo -e "    sudo /usr/local/bin/cassandra-admin replace <ip_of_dead_node>"
echo -e "    \`\`\`${NC}"
...
echo -e "    ${CYAN}\`\`\`bash"
echo -e "    sudo /usr/local/bin/cassandra-admin repair"
echo -e "    \`\`\`${NC}"
echo -e "*   ${BOLD}To repair a specific keyspace:${NC}"
echo -e "    ${CYAN}\`\`\`bash"
echo -e "    sudo /usr/local/bin/cassandra-admin repair my_keyspace"
echo -e "    \`\`\`${NC}"
...
echo -e "sudo /usr/local/bin/cassandra-admin compact -- -k my_keyspace -t my_table"
echo -e ""
echo -e "# Compact an entire keyspace"
echo -e "sudo /usr/local/bin/cassandra-admin compact -- -k my_keyspace"
echo -e "\`\`\`${NC}"
echo -e ""
...
echo -e ""
echo -e "${CYAN}\`\`\`bash"
echo -e "sudo /usr/local/bin/cassandra-admin garbage-collect -- -k my_keyspace -t users"
echo -e "\`\`\`${NC}"
echo -e ""
...
echo -e ""
echo -e "${CYAN}\`\`\`bash"
echo -e "sudo /usr/local/bin/cassandra-admin upgrade-sstables"
echo -e "\`\`\`${NC}"
echo -e ""
...
echo -e ""
echo -e "${CYAN}\`\`\`bash"
echo -e "sudo /usr/local/bin/cassandra-admin cleanup"
echo -e "\`\`\`${NC}"
echo -e ""
echo -e "---"
echo -e ""
...
echo -e "3.  ${BOLD}Execution:${NC} \`cron\` automatically triggers the backup scripts (\`full-backup-to-s3.sh\`, \`incremental-backup-to-s3.sh\`)."
...
echo -e "3.  ${BOLD}Execution:${NC} The timer runs the \`range-repair.sh\` script, which executes the intelligent Python script to repair the node in small, manageable chunks, minimizing performance impact."
...
echo -e ""
echo -e "This guide provides an in-depth, step-by-step walkthrough for recovering your Cassandra cluster from S3 backups using the powerful \`cassandra-admin restore\` command."
echo -e ""
...
echo -e ""
echo -e "The \`cassandra-admin restore\` script performs Point-in-Time Recovery (PITR). When you provide a target timestamp with \`--date\`:"
echo -e ""
...
echo -e "sudo /usr/local/bin/cassandra-admin restore -- \\"
