...
echo -e ""
echo -e "*   ${BOLD}Check the Local Node:${NC} Run \`sudo cass-ops health\`. This script is your first stop. It checks disk space, node status (UN), gossip state, active streams, and recent log exceptions, giving you a quick \"go/no-go\" for maintenance."
echo -e "*   ${BOLD}Check Cluster Connectivity:${NC} Run \`sudo cass-ops cluster-health\`. This verifies that the node can communicate with the cluster and that the CQL port is open."
echo -e "*   ${BOLD}Check Disk Space Manually:${NC} Run \`sudo cass-ops disk-health\` to see the current free space percentage on the data volume."
echo -e ""
...
echo -e "2.  Execute \`sudo cass-ops restart\`."
...
echo -e "2.  Run \`sudo cass-ops decommission\`."
...
echo -e "    ${CYAN}\`\`\`bash"
echo -e "    sudo cass-ops replace <ip_of_dead_node>"
echo -e "    \`\`\`${NC}"
...
echo -e "    ${CYAN}\`\`\`bash"
echo -e "    sudo cass-ops repair"
echo -e "    \`\`\`${NC}"
echo -e "*   ${BOLD}To manually repair a specific keyspace:${NC}"
echo -e "    ${CYAN}\`\`\`bash"
echo -e "    sudo cass-ops repair my_keyspace"
echo -e "    \`\`\`${NC}"
echo -e ""
...
echo -e "sudo cass-ops compact -k my_keyspace -t my_table"
echo -e ""
echo -e "# Compact an entire keyspace"
echo -e "sudo cass-ops compact -k my_keyspace"
echo -e "\`\`\`${NC}"
echo -e ""
...
echo -e ""
echo -e "${CYAN}\`\`\`bash"
echo -e "sudo cass-ops garbage-collect -k my_keyspace -t users"
echo -e "\`\`\`${NC}"
echo -e ""
...
echo -e ""
echo -e "${CYAN}\`\`\`bash"
echo -e "sudo cass-ops upgrade-sstables"
echo -e "\`\`\`${NC}"
echo -e ""
