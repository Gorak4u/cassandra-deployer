...
echo -e "\`\`\`${NC}"
echo -e "This will display the full, formatted help text with all commands grouped by category, including the critical 'disable-automation' and 'enable-automation' commands for safely managing maintenance windows."
echo -e ""
...
echo -e ""
echo -e "${BOLD}${BLUE}### Critical Safety: Disabling Automation for Maintenance${NC}"
echo -e ""
echo -e "> Before performing any significant, multi-step operation (like a complex restore, cluster join, or split), it is critical to prevent automated processes like Puppet or scheduled repairs from interfering."
echo -e ""
echo -e "*   ${BOLD}To Disable Automation:${NC} Run \`sudo cass-ops disable-automation 'Your maintenance message'\`. This stops the Puppet agent service and creates flag files that will prevent cron jobs from running."
echo -e "*   ${BOLD}To Re-enable Automation:${NC} Once your maintenance is complete and you have verified the cluster is healthy, run \`sudo cass-ops enable-automation\`."
echo -e ""
...
echo -e "> \`sudo cass-ops disable-automation 'Pausing backups'\` (this command disables all automation, including backups)."
echo -e "> To re-enable, simply run \`sudo cass-ops enable-automation\`."
echo -e ""
...
echo -e "4.  ${BOLD}Safety:${NC} The repair script checks for the flag file at \`/var/lib/repair-disabled\` (created by \`cass-ops disable-automation\`) and will pause if it exists."
echo -e "5.  ${BOLD}Control:${NC} You can manually stop, start, or check the status of a repair using \`systemd\` commands:"
